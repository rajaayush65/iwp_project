...
?>
            ...
            <h3><?php echo htmlentities($listdbooks);?>
            </h3>
            Books Listed
          </div>
        </div>
...
?>
            ...
            <h3><?php echo htmlentities($issuedbooks);?>
            </h3>
            Times Book Issued
          </div>
        </div>
...
?>
            ...
            <h3><?php echo htmlentities($returnedbooks);?>
            </h3>
...
?>
            <h3><?php echo htmlentities($regstds);?>
            </h3>
            Registered Users
          </div>
        </div>
...
?>
            ...
            <h3><?php echo htmlentities($listdathrs);?>
            </h3>
            Authors Listed
          </div>
        </div>
...
?>
            ...
            <h3><?php echo htmlentities($listdcats);?>
            </h3>
            Listed Categories
          </div>
        </div>
